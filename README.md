...
| 2026-05-22 | MCP Connectors Integration | GA |
| 2026-04-27 | Workspace files as context / SQL Author Skill | GA |
| 2026-04-09 | Plan Mode | GA |
| 2026-04-03 | Snap and Ask | GA |

### このデモで使う CoCo 機能

| 機能 | デモ | 用途 |
|------|------|------|
| CoCo Plugin (skills / commands / hooks) | Demo 1 | `/impact-check` スラッシュコマンド |
| `GET_LINEAGE` + Cortex Agent lineage | Demo 1 & 2 | 下流影響分析 |
| Plan Mode | Demo 2 | バッチ推論の実装計画 |
| `cortex exec` | — | CI/CD からの自動実行 (参考) |
| `snow app deploy` | Demo 2 | App Runtime のデプロイ |
